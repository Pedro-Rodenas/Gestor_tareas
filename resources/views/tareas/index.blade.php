        ...
        <div class="header-content">
            ...
            <form class="search-content" action="">
                <div class="search">
                    ...
                    <input class="control control-search" name="buscador" id="buscador" type="search"
                    ...
                    @foreach($tareas as $tarea)
                        <div class="row item">
                            ...
                            <div class="cell cell-actions">
                                {{-- EDITAR --}}
                                <button class="btn btn-secondary edit-btn" data-id="{{ $tarea->id }}"
                                ...
                                <form action="{{ route('tareas.destroy', $tarea->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-danger delete-btn" onclick="return confirm('¿Eliminar tarea?')"><i
                                            class='bxr  bx-trash'></i> </button>
                                </form>
